...
(when (eq 'solarized (car custom-enabled-themes))
  (set-face-attribute 'company-tooltip t
                      :inherit default :background "#fdf7e7")
  (set-face-attribute 'company-tooltip-common t
                      :inherit font-lock-constant-face)
  (set-face-attribute 'company-tooltip-search t
                      :inherit default :foreground "#d33682")
  (set-face-attribute 'company-tooltip-search-selection t
                      :inherit isearch)
