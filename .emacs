(custom-set-variables
 ...
 '(custom-safe-themes (quote ("ee999658dd90b50e8271e2067579d5dfd638c8670474af3a0025e3a4dd385c54" "ea28d99c67ee3f7758f57a078799ac9efcd8abcfc2cda9ff87107372507e8045" "50f82a02e9e902c96b1ca1bd0ccf58e2676586f6e57fb62da891adcf56af4bc5" "834b64f0b9608af58beb21140ffe8a0e676a34a3d4bd078f8364c7f1b902f38c" "769370c478110f9edca5f27bb2e6ff1b39c37a5a851f6510d403b18b3e931831" "5a2eb56fde1d85694d1f79dfddc27bcd0f09c76350d55e9bbeab4e9519988816" default)))
...
(when window-system (set-frame-size (selected-frame) 86 32))
...
(setq TeX-output-view-style
      (quote  (("^pdf$" "." "evince -f %o")
               ("^html?$" "." "firefox %o"))))
; Use "Ctrl + Mouse Left Click" to backward search, i.e. PDF -> LaTeX 
; Use "C-C C-V" to forward search, i.e. LaTeX -> PDF
; ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
;; disable visual-line-mode that starts by default, which is wrapping by words
;; use "wrap at window edge" to support Chinese word warp
...
(add-to-list 'term-bind-key-alist '("C-=" . multi-term-next))
  ;(add-to-list 'term-bind-key-alist '("C-x t" . multi-term-dedicated-toggle))
