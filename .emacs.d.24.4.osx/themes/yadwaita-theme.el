...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(fringehl ((,class (:background "#40E0D0"))))
  ...
  ;; The settings above were copied from adwaita-theme.el

  ;; Appearance of LaTeX source code 
  ...
  ;; Appearance of org-mode
   `(org-block-begin-line
        ((t (:underline "#A6A6AA" :foreground "#008ED1" :background "#EAEAFF"))))
   `(org-block-background
        ((t (:background "#FFFFEA"))))
   `(org-block-end-line
        ((t (:overline "#A7A6AA" :foreground "#008ED1" :background "#EAEAFF"))))

;; ;; The following are derived from "color-theme-leuven.el"
;; ;; `(org-document-info ((t (:foreground "#484848"))))
;; ;; `(org-document-info-keyword ((t (:foreground "#008ED1" :background "#EAEAFF"))))
;;    `(org-document-title ((t (:family "DejaVu Sans" :height 1.4 :weight bold :foreground "black"))))
;;    ;; `(org-level-1 ((t (:family "DejaVu Sans" :height 1.2 :weight bold :overline "#A7A7A7" :background "#F0F0F0"))))
;;    `(org-level-1 ((t (:family "DejaVu Sans" :height 1.0 :weight bold :overline "#A7A7A7" :background "#F0F0F0"))))
;;    `(org-level-2 ((t (:family "DejaVu Sans" :height 0.9 :weight bold :overline "#123555" :background "#E5F4FB"))))
;;    `(org-level-3 ((t (:height 1.0 :weight bold :overline "#005522" :background "#EFFFEF"))))
...
(provide-theme 'yadwaita)
;; Local Variables:
;; no-byte-compile: t
;; End:

;;; yadwaita-theme.el  ends here
